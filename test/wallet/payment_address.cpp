...
BOOST_AUTO_TEST_SUITE(payment_address_tests_c)
...
BOOST_AUTO_TEST_CASE(payment_address__construct__string_invalid__invalid_c)
{
...
BOOST_AUTO_TEST_CASE(payment_address__construct__secret__valid_expected_c)
{
    ec_secret secret;
...
BOOST_AUTO_TEST_CASE(payment_address__construct__secret_testnet__valid_expected_c)
{
    ec_secret secret;
    BOOST_REQUIRE(decode_base16(secret, SECRET));
...
BOOST_AUTO_TEST_CASE(payment_address__construct__secret_mainnet_uncompressed__valid_expected_c)
{
    ec_secret secret;
    BOOST_REQUIRE(decode_base16(secret, SECRET));
...
BOOST_AUTO_TEST_CASE(payment_address__construct__secret_testnet_uncompressed__valid_expected_c)
{
    ec_secret secret;
    BOOST_REQUIRE(decode_base16(secret, SECRET));
...
BOOST_AUTO_TEST_CASE(payment_address__construct__public__valid_expected_c)
{
...
BOOST_AUTO_TEST_CASE(payment_address__construct__public_testnet__valid_expected_c)
{
...
BOOST_AUTO_TEST_CASE(payment_address__construct__public_uncompressed__valid_expected_c)
{
...
BOOST_AUTO_TEST_CASE(payment_address__construct__public_testnet_uncompressed__valid_expected_c)
{
...
BOOST_AUTO_TEST_CASE(payment_address__construct__public_compressed_from_uncompressed_testnet__valid_expected_c)
{
...
BOOST_AUTO_TEST_CASE(payment_address__construct__public_uncompressed_from_compressed_testnet__valid_expected_c)
{
    ec_compressed point;
...
BOOST_AUTO_TEST_CASE(payment_address__construct__hash__valid_expected_c)
{
    short_hash hash;
...
BOOST_AUTO_TEST_CASE(payment_address__construct__uncompressed_hash_testnet__valid_expected_c)
{
    short_hash hash;
...
BOOST_AUTO_TEST_CASE(payment_address__construct__script__valid_expected_c)
{
    script ops;
...
BOOST_AUTO_TEST_CASE(payment_address__construct__script_testnet__valid_expected_c)
{
    script ops;
    BOOST_REQUIRE(ops.from_string(SCRIPT));
...
BOOST_AUTO_TEST_CASE(payment_address__construct__payment__valid_expected_c)
{
    payment pay;
...
BOOST_AUTO_TEST_CASE(payment_address__construct__payment_testnet__valid_expected_c)
{
    payment pay;
...
BOOST_AUTO_TEST_CASE(payment_address__construct__copy__valid_expected_c)
{
    payment pay;
    BOOST_REQUIRE(decode_base16(pay, PAYMENT));
    const payment_address address(pay);
...
BOOST_AUTO_TEST_CASE(payment_address__version__default__mainnet_c)
{
    const payment_address address(ec_public(COMPRESSED));
    BOOST_REQUIRE_EQUAL(address.version(), payment_address::mainnet_p2kh);
}

BOOST_AUTO_TEST_CASE(payment_address__version__testnet__testnet_c)
{
...
BOOST_AUTO_TEST_CASE(payment_address__version__script__valid_mainnet_p2sh_c)
{
    script ops;
    BOOST_REQUIRE(ops.from_string(SCRIPT));
    const payment_address address(ops);
...
BOOST_AUTO_TEST_CASE(payment_address__hash__compressed_point__expected_c)
{
    const payment_address address(ec_public(COMPRESSED));
    BOOST_REQUIRE(address);
