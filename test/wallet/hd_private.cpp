...
BOOST_AUTO_TEST_CASE(hd_private__encoded__round_trip__expected_c)
{
    ...
    bc_string_t* reencoded = bc_hd_private__encoded(key);
...
BOOST_AUTO_TEST_CASE(hd_private__derive_private__short_seed__expected_c)
{
    ...
    bc_hd_private_t* m0h1 = bc_hd_private__derive_private(
        m0h, 1);
    bc_hd_private_t* m0h12h = bc_hd_private__derive_private(
        m0h1, 2 + bc_hd_first_hardened_key());
    bc_hd_private_t* m0h12h2 = bc_hd_private__derive_private(
        m0h12h, 2);
    bc_hd_private_t* m0h12h2x = bc_hd_private__derive_private(
        m0h12h2, 1000000000);

    bc_string_t* m_encoded = bc_hd_private__encoded(m);
    BOOST_REQUIRE(bc_string__equals_cstr(m_encoded,
        "xprv9s21ZrQH143K3QTDL4LXw2F7HEK3wJUD2nW2nRk4stbPy6cq3jPPqjiChkVvvNKmPGJxWUtg6LnF5kejMRNNU3TGtRBeJgk33yuGBxrMPHi"));

    bc_string_t* m0h_encoded = bc_hd_private__encoded(m0h);
    BOOST_REQUIRE(bc_string__equals_cstr(m0h_encoded,
        "xprv9uHRZZhk6KAJC1avXpDAp4MDc3sQKNxDiPvvkX8Br5ngLNv1TxvUxt4cV1rGL5hj6KCesnDYUhd7oWgT11eZG7XnxHrnYeSvkzY7d2bhkJ7"));

    bc_string_t* m0h1_encoded = bc_hd_private__encoded(m0h1);
    BOOST_REQUIRE(bc_string__equals_cstr(m0h1_encoded,
        "xprv9wTYmMFdV23N2TdNG573QoEsfRrWKQgWeibmLntzniatZvR9BmLnvSxqu53Kw1UmYPxLgboyZQaXwTCg8MSY3H2EU4pWcQDnRnrVA1xe8fs"));

    bc_string_t* m0h12h_encoded = bc_hd_private__encoded(m0h12h);
    BOOST_REQUIRE(bc_string__equals_cstr(m0h12h_encoded,
        "xprv9z4pot5VBttmtdRTWfWQmoH1taj2axGVzFqSb8C9xaxKymcFzXBDptWmT7FwuEzG3ryjH4ktypQSAewRiNMjANTtpgP4mLTj34bhnZX7UiM"));

    bc_string_t* m0h12h2_encoded = bc_hd_private__encoded(m0h12h2);
    BOOST_REQUIRE(bc_string__equals_cstr(m0h12h2_encoded,
        "xprvA2JDeKCSNNZky6uBCviVfJSKyQ1mDYahRjijr5idH2WwLsEd4Hsb2Tyh8RfQMuPh7f7RtyzTtdrbdqqsunu5Mm3wDvUAKRHSC34sJ7in334"));

    bc_string_t* m0h12h2x_encoded = bc_hd_private__encoded(m0h12h2x);
    BOOST_REQUIRE(bc_string__equals_cstr(m0h12h2x_encoded,
...
BOOST_AUTO_TEST_CASE(hd_private__derive_private__long_seed__expected_c)
{
    ...
    bc_hd_private_t* m0xH1 = bc_hd_private__derive_private(
        m0xH, 1);
    bc_hd_private_t* m0xH1yH = bc_hd_private__derive_private(
        m0xH1, 2147483646 + bc_hd_first_hardened_key());
    bc_hd_private_t* m0xH1yH2 = bc_hd_private__derive_private(
        m0xH1yH, 2);
    ...
    bc_string_t* m0_encoded = bc_hd_private__encoded(m0);
    BOOST_REQUIRE(bc_string__equals_cstr(m0_encoded,
        "xprv9vHkqa6EV4sPZHYqZznhT2NPtPCjKuDKGY38FBWLvgaDx45zo9WQRUT3dKYnjwih2yJD9mkrocEZXo1ex8G81dwSM1fwqWpWkeS3v86pgKt"));

    bc_string_t* m0xH_encoded = bc_hd_private__encoded(m0xH);
    BOOST_REQUIRE(bc_string__equals_cstr(m0xH_encoded,
        "xprv9wSp6B7kry3Vj9m1zSnLvN3xH8RdsPP1Mh7fAaR7aRLcQMKTR2vidYEeEg2mUCTAwCd6vnxVrcjfy2kRgVsFawNzmjuHc2YmYRmagcEPdU9"));

    bc_string_t* m0xH1_encoded = bc_hd_private__encoded(m0xH1);
    BOOST_REQUIRE(bc_string__equals_cstr(m0xH1_encoded,
        "xprv9zFnWC6h2cLgpmSA46vutJzBcfJ8yaJGg8cX1e5StJh45BBciYTRXSd25UEPVuesF9yog62tGAQtHjXajPPdbRCHuWS6T8XA2ECKADdw4Ef"));

    bc_string_t* m0xH1yH_encoded = bc_hd_private__encoded(m0xH1yH);
    BOOST_REQUIRE(bc_string__equals_cstr(m0xH1yH_encoded,
        "xprvA1RpRA33e1JQ7ifknakTFpgNXPmW2YvmhqLQYMmrj4xJXXWYpDPS3xz7iAxn8L39njGVyuoseXzU6rcxFLJ8HFsTjSyQbLYnMpCqE2VbFWc"));

    bc_string_t* m0xH1yH2_encoded = bc_hd_private__encoded(m0xH1yH2);
    BOOST_REQUIRE(bc_string__equals_cstr(m0xH1yH2_encoded,
...
BOOST_AUTO_TEST_CASE(hd_private__derive_public__long_seed__expected_c)
{
    ...
    bc_hd_public_t* m_pub = bc_hd_private__to_public(m);
    bc_hd_public_t* m0_pub = bc_hd_private__derive_public(
        m, 0);
    bc_hd_public_t* m0xH_pub = bc_hd_private__derive_public(
        m0, 2147483647 + bc_hd_first_hardened_key());
    bc_hd_public_t* m0xH1_pub = bc_hd_private__derive_public(
        m0xH, 1);
    bc_hd_public_t* m0xH1yH_pub = bc_hd_private__derive_public(
        m0xH1, 2147483646 + bc_hd_first_hardened_key());
    bc_hd_public_t* m0xH1yH2_pub = bc_hd_private__derive_public(
        m0xH1yH, 2);
