 ...
 */
#ifndef LIBBITCOIN_C_TEST_SCRIPT_HPP
#define LIBBITCOIN_C_TEST_SCRIPT_HPP
...
{ {
    { "", "NOP2", "Empty NOP2" },
    { "", "CHECKLOCKTIMEVERIFY", "Empty CLTV" }
}};
...
{{
    ...
    { "1", "NOP1 NOP3 NOP4 NOP5 NOP6 NOP7 NOP8 NOP9 NOP10 1 EQUAL", "" },
    { "'NOP_1_to_10' NOP1 NOP3 NOP4 NOP5 NOP6 NOP7 NOP8 NOP9 NOP10", "'NOP_1_to_10' EQUAL", "" },
